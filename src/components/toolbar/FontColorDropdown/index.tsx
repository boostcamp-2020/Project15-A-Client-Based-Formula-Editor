...
const FontColorDropdown  = () => {
    const {isActive, fontColor} = useSelector((state:rootState)=> state.fontColorDropdownHandler);
    ...
    return(
        <StyleComponent.FontColorDropdown>
            <FontColorButton isActive={isActive} onClick={onClickHandler} fontColor={fontColor}/>
